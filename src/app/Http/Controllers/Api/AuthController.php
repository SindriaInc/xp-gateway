...
class AuthController extends ApiController
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/realms/'.env('AUTH_REALM').'/protocol/openid-connect/token';
    ...
    public function logout(Request $request)
    {
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/realms/'.env('AUTH_REALM').'/protocol/openid-connect/revoke';
    ...
    public function user(Request $request)
    {
        try {
            ...
            $url_info = env('AUTH_SERVICE').'/auth/realms/'.env('AUTH_REALM').'/protocol/openid-connect/userinfo';
