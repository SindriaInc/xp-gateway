...
class UsersController extends ApiController
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/admin/realms/'.env('AUTH_REALM').'/users';
    ...
    public function showUserByUsername(ShowUserRequest $request)
    {
        ...
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/admin/realms/'.env('AUTH_REALM').'/users?username='. $validated['username'];
    ...
    public function edit(EditUserRequest $request)
    {
        ...
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/admin/realms/'.env('AUTH_REALM').'/users/' . $validated['id'];
            $payload = json_encode($form);
    ...
    public function search(SearchUserRequest $request)
    {
        ...
        try {
            ...
            $url = env('AUTH_SERVICE').'/auth/admin/realms/'.env('AUTH_REALM').'/users?search='. $validated['query'];
